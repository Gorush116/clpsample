package com.clp.service.common.service;

import com.clp.service.common.enums.ApiEndpoint;
import com.clp.service.common.exception.ApiException;
import com.clp.service.common.request.ApiRequest;
import com.clp.service.common.response.ApiFailResponse;
import com.clp.service.common.response.ApiResponse;
import com.clp.service.common.response.ApiSuccessResponse;
import com.clp.service.common.utils.RequestUtil;
...
public class ApiService {
    ...
    public ApiResponse callWithRequest(ApiEndpoint endpoint, Object request, Object... uriVariables) {
        String uri = RequestUtil.buildUri(apiBaseUrl, endpoint, uriVariables);
        HttpEntity<?> entity = new HttpEntity<>(request, RequestUtil.createHeaders(token));
